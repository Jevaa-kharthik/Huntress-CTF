# The provided QR code PNG hex string
...
# Step 1: Decode the escape sequences to get the bytes directly
image_bytes = bytes(hex_string, 'utf-8').decode('unicode_escape').encode('latin1')

# Step 2: Write the bytes to a PNG file
with open("output_qr_code.png", "wb") as image_file:
    image_file.write(image_bytes)

print("QR Code image has been created as 'output_qr_code.png'.")
